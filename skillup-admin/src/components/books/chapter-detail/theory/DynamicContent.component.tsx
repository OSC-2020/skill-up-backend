    ...
    return (
        <section className="flex justify-center py-8 w-full">
            <article className="w-2/3">
                ...
                <div className=" my-4 flex justify-center border-dashed border-2 border-gray-300 cursor-pointer py-2 skillup-text-color-primary skillup-background-color-bg  hover:border-blue-300 rounded duration-200"
